...
(function() {
    ...
    /* para saber a donde estoy(sit1 o sit2) al entrar por primera vez y que cargue el contenido(min 20)*/ window.addEventListener("load", ()=>{
